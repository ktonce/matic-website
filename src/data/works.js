...
export const works = [
  ...
  { id: 'volvo',     cat: 'Automezzi',    tag: 'AUTOMEZZI',    settore: '',          localita: 'Italia',  cliente: '', title: 'Decorazione mezzo pesante',           desc: 'Rivestimento integrale di un mezzo pesante.', ratio: '16 / 9',         href: '/decorazione-automezzi', hrefLabel: 'Vedi la decorazione automezzi',    img: '/media/portfolio-volvo.jpg',     alt: 'Mezzo pesante rivestito integralmente con grafica realizzata da MATIC' }
];
